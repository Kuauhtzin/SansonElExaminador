...
public class SecurityControllerServlet extends HttpServlet
{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		//Permite a un llamado responder una peticion
		...
		//El dispatcher se encarga de administrar las vistas a los usuarios
	}
	/**
	 * 
	 * @param request
	...
	private String authenticate(HttpServletRequest request)
	{
		...
		String nextView  = null;
		UserValueObject usuario = null; //objeto de obtencion de valor
		UserDAO dao = null; //objeto de conexion
